        ...
        <Container>
          <AutoLayout name="Conent File" minWidth={100} overflow="visible" verticalAlignItems="center">
            <Image
              ...
              width={74}
              height={74}
              src={isImg ? PreviewImage64 : ICON_MAP[theme][dir]}
            />
            <AutoLayout
              name="Stats"
              overflow="visible"
            ...
            >
              <AutoLayout name="Frame 3" overflow="visible" width="fill-parent">
                ...
                <Text name="EXT" fill={color.text[`primary${dir}`]} lineHeight={21} letterSpacing={-0.3} strokeWidth={0} strokeAlign="center">
                  {extension}
                </Text>
              </AutoLayout>
              <AutoLayout name="Frame 2" overflow="visible" width={43}>
                <Text name="SIZE" fill={color.text[`label${dir}`]} fontSize={13} letterSpacing={-0.1} strokeWidth={0} strokeAlign="center">
                  {size}
                </Text>
    ...
    case 2: {
      ...
      return (
        <Container>
          <AutoLayout
            name="Content Image"
            minHeight={!text ? 150 : 135}
            minWidth={!text ? 250 : 118}
            overflow="visible"
            direction="vertical"
            spacing={8}
            width="fill-parent"
